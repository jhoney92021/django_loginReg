...
class Users(models.Model):
    fname = models.CharField(max_length=80, default='A person with no name apparently')
    lname = models.CharField(max_length=80, default='A person with no name apparently')
